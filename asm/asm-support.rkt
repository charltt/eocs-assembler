...
(define (extract-comp exp)
  (cond
    [(regexp-match? DCJ-REGEXP exp) (string->number-or-symbol (third (regexp-match DCJ-REGEXP exp)))]
    [(regexp-match? CJ-REGEXP exp) (string->number-or-symbol (second (regexp-match CJ-REGEXP exp)))]
    [(regexp-match? DC-REGEXP exp) (string->number-or-symbol (third (regexp-match DC-REGEXP exp)))]
    [(regexp-match? C-REGEXP exp) (string->number-or-symbol (second (regexp-match C-REGEXP exp)))]
    ))
...
(define (extract-dest exp)
  (cond
    [(regexp-match? DCJ-REGEXP exp) (string->number-or-symbol (second (regexp-match DCJ-REGEXP exp)))]
    [(regexp-match? DC-REGEXP exp) (string->number-or-symbol (second (regexp-match DC-REGEXP exp)))]
    ))
...
(define (extract-jump exp)
  (cond
    [(regexp-match? DCJ-REGEXP exp) (string->number-or-symbol (fourth (regexp-match DCJ-REGEXP exp)))]
    [(regexp-match? CJ-REGEXP exp) (string->number-or-symbol (third (regexp-match CJ-REGEXP exp)))]
    ))